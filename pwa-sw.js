...
const OFFLINE_PAGE = 'https://elsiegram.com/';
const NOT_FOUND_PAGE = 'https://elsiegram.com/';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://elsiegram.com//wp-admin/');
//    },
];
