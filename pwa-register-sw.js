                                 var swsource = "https://elsiegram.com/pwa-sw.js";                                          
              ...
              function PWAforwpreadCookie(name) {
                  ...
                  return null;
			         ...
			         if("serviceWorker" in navigator) {
			                ...
			                navigator.serviceWorker.register(swsource, {scope: 'https://elsiegram.com/'}).then(function(reg){                                                                                        
    ...
    if((window.matchMedia('(display-mode: standalone)').matches) || (window.matchMedia('(display-mode: fullscreen)').matches) || (isSafari && iOS && window.navigator.standalone ) ){
      if(PWAforwpreadCookie('reloadInAPP')!='Yes' && 'cacheFirst'=='networkFirst'){
        var date = new Date();
